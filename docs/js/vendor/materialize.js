...
(function (window) {
  ...
  /**
   * Selection the click and show effect if .waves-effect elem was found
   */
   ...
   * selection mouseup/mousedown events).
    ...
    _createClass(
      ...
      [
        ...
        },
        {
          ...
          /**
           * morph thumb into selection
           */
        },
        {
          key: "_showRangeSelection",
          value: function _showRangeSelection() {
